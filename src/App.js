...
const Modal = (props) => {
    ...
    //Первый вариант - использование Transition
    ...
    //                                 Close
    //                             </button>
    //                             <button onClick={() => props.onClose(false)} type="button" className="btn btn-primary">
    //                                 Save changes
    //                             </button>
    //                         </div>
    //                     </div>
    ...
    // 2-й вариант - использование CSSTransition
    return (
        <CSSTransition
            in={props.show}
            timeout={duration}
